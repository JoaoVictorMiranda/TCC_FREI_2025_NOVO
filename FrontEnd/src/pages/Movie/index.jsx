                ...
                <div className='EspacoDetalhes'>
                    ...
                    <div className="DetalhesAlinhador">
                        ...
                        <div className="Information">
                            <CardDetalhes Info={'Assistiram'} Quantidade={`${count ? count : '0'}`} />
                            <CardDetalhes Quantidade={`${media ? media : '0'}`} Info={'Aproveitamento'} />
                            <CardDetalhes Quantidade={`${count ? count : '0'}`} Info={'Análises'} />
                        </div>
